...
std::shared_ptr<VictorSP> RobotMap::driverDrive;
std::shared_ptr<VictorSP> RobotMap::drivelDrive;
...
void RobotMap::init() {
    ...
    driverDrive.reset(new VictorSP(0));
    lw->AddActuator("Drive", "rDrive", std::static_pointer_cast<VictorSP>(driverDrive));
    
    drivelDrive.reset(new VictorSP(1));
    lw->AddActuator("Drive", "lDrive", std::static_pointer_cast<VictorSP>(drivelDrive));
